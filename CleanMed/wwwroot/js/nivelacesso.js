...
$(function () {
    $(".btnEdit").click(function () {
        ...
        $("#modal").load("/NiveisAcessos/Edit/" + id, function () {
            var elem = document.querySelector('#modal');
            var instance = M.Modal.init(elem, {
                onOpenStart: function () {

                    $('#modal').attr('style', 'z-index: 1005; display: block; opacity: 1; top: 10%; transform: scaleX(1) scaleY(1);width:400px;');
                }
            });
            instance.open();
        })
    ...
    $(".btnAdd").click(function () {
        $("#modal").load("/NiveisAcessos/Create", function () {
            var elem = document.querySelector('#modal');
            var instance = M.Modal.init(elem, {
                onOpenStart: function () {
